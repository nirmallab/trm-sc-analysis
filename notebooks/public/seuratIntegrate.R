library(Seurat)
batch_key = "batch"
seurat = LoadSeuratRds('../../data/external/stubenvoll_processed_seurat.rds')
print('Seurat object')
...
SaveSeuratRds(integrated_expr, '../../data/external/stubenvoll_processed_seurat_integration.rds')
